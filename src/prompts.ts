...
export const GROWSURF_PROMPTS: GrowSurfPrompt[] = [
  {
    ...
    render: (args) => {
      ...
      return [
        ...
        "3. Review the seeded starter Design, Emails, Options, Installation, rewards, and GrowSurf Window content before changing anything. Check Window header/share copy, referred-friend and landing-page content, email templates, and install settings.",
        ...
        "6. Generate installation guidance with growsurf_client_snippets and, when available, produce referrer and referred-friend screenshots for confirmation.",
        "",
  ...
  },
  {
    ...
    render: (args) => {
      ...
      return [
        ...
        "2. Capture the returned id and pass it as campaignId on every campaign-scoped tool call.",
        "3. Review the seeded affiliate reward config and starter content before changing it, including Design, Emails, Options, Installation, and GrowSurf Window content. Do not enable payout exposure until the user confirms commission terms and payout operations.",
        ...
        "6. Fetch the final Design, Emails, Options, Installation, and rewards state and summarize what the user should inspect in the Campaign Editor.",
        "",
        `Preferred program name: ${campaignName}.`,
      ].join("\n");
    },
