...
export const GROWSURF_PROMPTS: GrowSurfPrompt[] = [
  {
    ...
    render: (args) => {
      ...
      return [
        ...
        "12. Show the draft, do not just describe it: call growsurf_capture_referral_flow_screenshots and show the returned referrer Window and referred-friend images inline as GrowSurf preview screenshots of the draft, not the user's site. Do this after the draft is saved and again whenever a later change touches a browser-visible GrowSurf flow; skip it for read-only or config-only work. For screenshot proof of the user's own installed site, use the host agent's browser automation tool, such as Playwright or a built-in browser tool, against the real installed page.",
  ...
  },
  {
    ...
    render: (args) => {
      ...
      return [
        ...
        "10. Show the draft, do not just describe it: call growsurf_capture_referral_flow_screenshots and show the returned referrer Window and referred-friend images inline as GrowSurf preview screenshots of the draft, not the user's site. Do this after the draft is saved and again whenever a later change touches a browser-visible GrowSurf flow; skip it for read-only or config-only work. For screenshot proof of the user's own installed site, use the host agent's browser automation tool, such as Playwright or a built-in browser tool, against the real installed page.",
