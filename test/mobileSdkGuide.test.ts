...
describe("renderMobileSdkGuide", () => {
  it("renders SDK 0.4.0 native window guidance for both mobile platforms", () => {
    ...
    expect(text).toContain("SDK version `0.4.0`");
  ...
  it("emits released public SDK 0.4.0 install coordinates", () => {
    const text = renderMobileSdkGuide(
      {
        platform: "both",
        attributionProvider: "all",
